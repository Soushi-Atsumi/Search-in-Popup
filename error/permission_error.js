...
function initDocuments() {
	...
	document.getElementById('errorMessageHeading1').innerText = browser.i18n.getMessage('permissionErrorTabs');
	document.getElementById('errorMessageParagraph1').innerText = browser.i18n.getMessage('permissionErrorTabsDescription');
}
