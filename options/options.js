...
function searchEngineOnClick(event) {
	switch (event.target.id) {
		case askRadioId:
			...
			break;
		case bingRadioId:
			browser.storage.local.set({ searchEngine: searchEngines.bing.name });
			break;
		case duckduckgoRadioId:
			browser.storage.local.set({ searchEngine: searchEngines.duckduckgo.name });
			break;
		case googleRadioId:
			browser.storage.local.set({ searchEngine: searchEngines.google.name});
			break;
		case yahooRadioId:
			browser.storage.local.set({ searchEngine: searchEngines.yahoo.name});
			break;
		case yahooJapanRadioId:
			browser.storage.local.set({ searchEngine: searchEngines.yahooJapan.name });
			break;
	}
